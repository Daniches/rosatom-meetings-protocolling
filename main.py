...
class Ui(QtWidgets.QDialog, Form):
    ...
    def hintmeplease(self):
        QMessageBox.about(self, "Добро пожаловать!",
                          "Чтобы добавить файл, нажмите кнопку открыть файл и выберите файл формата "
                          "'mp4', 'mp3' или 'acc'."
                          ...
                          + '\n' + "Чтобы принять результат, нажмите кнопку Да. В этом случае Вам откроется "
                                   "папка, содержащая исходный файл и файл протокола."
                          + '\n' + "Чтобы не принять результат, нажмите кнопку Нет, в этом случае файл протокола "
                                   "сохранён не будет."
                          )
